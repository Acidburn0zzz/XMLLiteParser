...
\begin{frame}
 ...
 \pause
 \begin{block}{Solution}
  Un document XML ayant déjà une structure d'arbre,nous avons adopter une structure d'arbre pour la représentation.
 \end{block}
 \begin{center}
...
<!ELEMENT VALID ()>
      \end{lstlisting}
  \end{block}
	\begin{block}{Interpréteur QCM}
Remplir un objet QCM en utilisant l'arbre généré par le parser.
	\end{block}
 \end{block}
\end{frame}
...
\begin{frame}
 ...
 \begin{block}{Observation}
  ...
  Implémentation des différents prolongements possibles.
 \end{block}
 \pause  
 \begin{block}{Difficultés rencontrées}
  Parseur DTD, regex -> automate.
 \end{block}
 \pause
