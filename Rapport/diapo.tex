...
\begin{frame}
	...
	L'utilisation d'un langage simplifié de XML nous permet de développer un programme réalisable dans le contexte donné tout en facilitant 
	l'utilisation, les performances ainsi que les normes de conformité (XML 1.0).
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Les différents prolongements du sujet}
	 \begin{itemize}
	  \item Permettre le débugage du fichier XML.
...
\begin{frame}
	...
	\begin{block}{Parseur}
	 \lstinputlisting[language=java, firstline=1, lastline=8]{../src/XMLLiteParser/main.java}
	\end{block}
...
\begin{frame}
	...
	\begin{block}{Validateur}
	 \lstinputlisting[language=java, firstline=13, lastline=22]{../src/XMLLiteParser/main.java}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Interpréteur}
	 \lstinputlisting[language=java, firstline=23, lastline=45]{../src/XMLLiteParser/main.java}
	\end{block}
\end{frame}
