...
\subsection{Permettre le débuggage du fichier XML.} %Quel impact cette modification a eu sur la structure mathématique utilisée ?
Le modèle d'automate permet une vérification à la volée dans le parseur.

\subsection{Permettre au validateur de s'accorder à un schéma prédéfini.}%Quel impact cette modification a eu sur la structure mathématique utilisée ?
