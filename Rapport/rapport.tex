...
\section{Conclusion}
Ce projet aura été d'une grande expérience pour notre groupe. La création d'un outil permettant de parser et valider des 
documents XML-Lite tout en s'accordant sur un schéma prédéfini ou non nous a permis tout comme nous l'esperions au commencement 
de ce projet de découvrir les principes de base du XML mais également l'implémentation et la gestion d'un automate fini.
En effet, 
